...
cf LINES[9] = {0, 0, 0, 308, 1080, 1800, 0, MAIN_DRAG, -1};
cf BORDER[9] = {594, 1000, 0, 2270, 90, 200, 0, MAIN_DRAG, -1};
cf SHOP[9] = {1466, 44, 880, 10, 138, 260, 0, MAIN_DRAG, -1};
cf TOWERS[9] = {1424, 211, 0, 2355, 262, 340, 0, MAIN_DRAG, -1};
cf MISSILES[9] = {1424, 613, 345, 2355, 262, 340, 0, MAIN_DRAG, -1};
cf TANKS[9] = {1424, 462, 0, 2618, 163, 340, 0, MAIN_DRAG, -1};
cf PLANES[9] = {1424, 864, 345, 2618, 163, 340, 0, MAIN_DRAG, -1};
cf EXIT_PLATE[9] = {0, 370, 1246, 0, 144, 61, 0, MAIN_DRAG, -1};
cf ENTER_PLATE[9] = {1321, 370, 1186, 0, 144, 61, 0, MAIN_DRAG, -1};
cf COINS[9] = {1220, 894, 1331, 0, 80, 150, 2, MAIN_DRAG, -1};
cf EMERALDS[9] = {1220, 954, 1331, 80, 80, 150, 2, MAIN_DRAG, -1};
